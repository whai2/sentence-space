...
class ChatRepository:
    ...
    async def create_chat(self, chat_doc: ChatDocument) -> str:
        ...
        Raises:
            Exception: 채팅 생성 실패 시
        """
        # created_at이 설정되지 않은 경우 현재 시간으로 설정
    ...
    async def create_indexes(self) -> None:
        """
        컬렉션 인덱스 생성
        - session_id: 세션별 조회 성능 향상
        - created_at: 시간순 정렬 성능 향상
        """
